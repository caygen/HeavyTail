...
# filename = 'PtCl_Zif8_degas1' ; bottomLabel = '{}' ; yscale = 1 ; unit = ''
...
# folder    = 'TAU'
# # filename  = '5s1Stress'; dataOffset = 3;
# filename  = '5s1Resistance'; dataOffset = 32;

# # filename  = '6s1m1Stress'; dataOffset = 2;
# # filename  = '6s1m1Resistance'; dataOffset = 2;
# # 
# # filename = '6s1m2Stress' ;dataOffset = 2;
# # filename  = '6s1m2Resistance'; dataOffset = 13;
# # 
# # filename = '6s2m1Stress' ; dataOffset = 2;
# # filename = '6s2m1Resistance';  dataOffset = 2;

# # filename = '6s2m2Stress' ;dataOffset = 2;
# # filename = '6s2m2Resistance'; dataOffset = 0;
...
# filename  = 'VTo-TricbzBz'
# filename  = 'VTo-DicbzBz'
...
# June
# June Comparison Datasets
# letter = 'f';bottomLabel = '4'+letter; topLabel = '{\ June \ \'13}';unit = '[a.u.]'; timeunit = 'sec'
# folder  = 'June(Bio)'
# filename = 'June4{}'.format(letter)

# compare = 2

# bottomLabel = ' Cartilage '
# bottomLabel = ' Bone '

# fileComp = 'Dataset_4{0}_Gray'.format(str.upper(letter))
# # fileComp2= 'Dataset_4{0}_Black'.format(str.upper(letter))

# interpolateData = False
# June2
# folder = 'June2'
# topLabel = '{\ June_2}'; unit = 'MPa'; yscale=1; timeunit = 'sec'
# filename =  'June2'       ; bottomLabel = r'{2}'; compare = 0

#-----------------------------------------------------------------------------
#Comparison Import
# if compare > 0:
#     comParams[2] = comParams[2]*yscale
#     DataX2 = DataX;
#     # DataY2 = MunsterFit(np.array(Ti),np.array(Ai),DataX2)*yscale
#     DataY2 = FHTx(DataX2, *comParams)
    
    
# if compare == 2:
#     # fileComp2 = filename[0:-3] + 'fitted';
#     file3 = '../Literature/{0}/ImportedData/{1}.csv'.format(folder,fileComp)
    
#     csv3 = np.genfromtxt (file3, delimiter=",")
#     DataX3= np.log(csv3[:,0])
#     DataY3 = csv3[:,1]*yscale
    
    
# if compare == 2:
#     ret3 = heavyTailFit(x = DataX3, y = DataY3, uBounds = uBounds, bBounds = bBounds,
#                         df0Bounds = df0Bounds,# (0,1),
#                         MBounds = MBounds)
    
#     compareSig2= Modsigma(DataX,DataY,*ret3.x)
...
# # LEV DATA (Oman 2009)
# folder   = 'Lev'
# filename = 'Stress_Figure_12a_23C_500percent'
# timeunit = 's'
# unit     = 'Mpa'
# dataOffset = 1
